...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">ADD NEW VIDEO ACCESS
   ...
   <div class="row middle-hight">
           ...
           <div class="card p-3">
              <div class="row">
                 ...
                 <div class="col-6 mx-auto pt-3 text-center">
                    ...
                    <a href="{{ route('web.fees.payment_history') }}" class=" w-100 text-uppercase font-14 text-white
                    rounded-pill py-2 px-3 bg-primary fw-500 align-items-center   hvr-shrink">VIEW PAYMENT HISTORY
                 </a>
                 </div>
              </div>
           </div>
      ...
      <div class="col-12">
         <div class="table-responsive  ">
            <table id="addRecAccess" class="table table-striped table-hover table-bordered">
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                aria-label=".form-select-lg example">
                                    <option selected="">Select Month Dropdown</option>
