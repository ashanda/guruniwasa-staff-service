...
<div class="container-fluid">
    <div class="row align-items-center pt-2">
        ...
        <div class="col-lg-6 col-sm-6 text-center">
            <h1 class="font-36 fw-bold text-uppercase text-purple">BANK PAYMENT 
            ...
            <div class="border-new pt-3 pb-5 px-3 rounded-35 bg-white text-center">
                ...
                <div class="row justify-content-center pt-4">
                    <div class="col-lg-10 text-white e">
                        <a href="{{ route('web.fees.class_fess_bank_payment', ['month' => $x, 'payment_type' => 'Bank']) }}" class="w-100 text-uppercase font-14 text-white rounded-pill py-2 px-3 bg-primary fw-500 align-items-center hvr-shrink">
                            See more
                        </a>
                    </div>
                </div>
