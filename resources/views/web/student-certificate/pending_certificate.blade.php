...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">PENDING CERTIFICATES
         </h1>
      </div>
   ...
   <div class="row middle-hight">
      <div class="col-12">
         <div class="table-responsive  ">
            <table id="pendingCertificateTbl" class="table table-striped table-hover table-bordered">
            ...
            alt="Guru Niwasa LMS">
                     ...
                     <td>
                        ...
                        <button class="btn btn-success fw-500 font-11 px-5 rounded-pill text-white  "
                              ...
                              <div class="modal-body ">
                                 <div class="row">
                                    <div class="col-12">
                                      <form action="">
                                        <div class="mb-2">
                                            <label class="form-label font-14 fw-bold text-purple  mb-0">Add Comment </label>
