    ...
    <div class="border-new pt-3 pb-5 px-3 mx-lg-0 mx-sm-0 mx-3  rounded-35 bg-white text-center">
        ...
        <div class="row justify-content-center pt-4">
           <div class="col-lg-10 text-white ">
              <a href="{{ route('web.teachers.class_video_analysing') }}" class=" w-100 text-uppercase font-14 text-white rounded-pill py-2 px-3 bg-primary fw-500 align-items-center   hvr-shrink">See More</a>
           </div>
        </div>
