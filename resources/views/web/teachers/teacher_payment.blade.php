...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-3 col-sm-3 pt-lg-0 pt-3 text-end">
        <p>
            <a href="{{ route('web.teachers.payment_analysing') }}" class="text-white bg-primary font-14 fw-500
                       rounded-pill px-3 py-2 hvr-shrink"> PAYMENT ANALYSING
                    </a></p>
      </div>
   </div>
</div>
      ...
      <div class="row middle-hight">
         <div  class="col-lg-3 col-sm-4 mb-3 align-items-center">
            <div class="border-new pt-3 pb-5 px-3 mx-lg-0 mx-sm-0 mx-3  rounded-35 bg-white text-center">
               <i class="fa-solid fa-money-bill  fs-1 text-purple mb-3"></i>
               <p
               ...
               <div class="row justify-content-center pt-4">
                  <div class="col-lg-10 text-white ">
                     <a href="{{ route('web.teachers.teacher_payment_view') }}" class=" w-100 text-uppercase font-14 text-white rounded-pill py-2 px-3 bg-primary fw-500 align-items-center   hvr-shrink">See More</a>
                  </div>
               </div>
            </div>
         </div>
