   ...
   <div class="container">
      <div class="row middle-hight justify-content-center align-items-center">
         ...
         <div class="col-lg-3 pt-lg-0 pt-3">
            ...
            <p class="mb-2">
                <a href="{{  route('web.order-cart') }}" class=" hvr-shrink font-14 text-dark fw-bolder bg-warning py-2 px-5 justify-content-around rounded-35">
                      Buy Now
                    </a>
            </p>
            ...
            <p>
                <a href="" class=" hvr-shrink font-14 text-white fw-bolder gradient-background-1 py-2 px-5 justify-content-around rounded-35">
