...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-36 fw-bold text-uppercase text-purple">ITEM SHOP PAYMENTS
         ...
         <div class="col-12">
            <div class="row justify-content-center mb-5">
               <div class="col-lg-3 col-sm-6 col-12 text-center ">
                  <a href="{{ route('web.pending-items') }}" class="text-white
                   bg-warning font-14 fw-500 w-100  rounded-pill px-3 py-3 me-2 hvr-shrink">PENDING ITEMS
                  <span class="badge badge-custom bg-dark ms-1 font-13">6</span></a>
               </div>
               <div class="col-lg-3 col-sm-6  col-12 text-center pt-lg-0 pt-sm-0 pt-3">
                  <a href="{{ route('web.add-order') }}" class="text-white bg-primary
                  font-14 fw-500 w-100  rounded-pill px-3 py-3 hvr-shrink">ADD ORDER
                </a>
               </div>
            </div>
                        ...
                        <div class="col-lg-6 col-sm-6">
                           ...
                           <div class="dropdown">
                              ...
                              <ul class="dropdown-menu px-2 w-100" aria-labelledby="dropdownMenuButton">
                                 ...
                                 <li class="dropdown-checkbox">
                                    <input class="form-check-input" type="checkbox" value="" id="option3">
                                    <label class="form-check-label ms-2  font-13 fw-bolder text-danger" for="option3">
                                    REJECTED PAYMENTS
                                    </label>
                                 </li>
                              </ul>
